...
interface SupplierDriverDetails {
    firstName: string;
    middleName: string;
    lastName: string;
    dateOfBirth: string;
...
const supplierDriverSchema = new Schema<SupplierDriverDetails>({
    firstName: {
        type: String,
        required: false
    },
...
export default model<SupplierDriverDetails>("supplier-driver", supplierDriverSchema)
